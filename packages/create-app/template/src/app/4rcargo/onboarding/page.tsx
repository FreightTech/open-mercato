...
export default function FRCargoOnboardingPage() {
  const t = useT()
        ...
        <Card className="w-full max-w-lg border-0 bg-white shadow-2xl">
          <CardHeader className="flex flex-col items-center gap-4 px-10 pt-10 pb-4">
            <div className="flex flex-col items-center gap-3">
              ...
              <CardTitle className="text-2xl font-semibold flex justify-center text-gray-900">
          ...
          <CardContent className="px-10 pb-10">
            ...
            <form className="grid gap-4" onSubmit={onSubmit} noValidate>
              <div className="grid gap-1">
                <Label htmlFor="email" className="text-gray-700">{translate('onboarding.form.email', 'Work email')}</Label>
                <Input
                  id="email"
                  name="email"
                  type="email"
                  ...
                  className={`border-gray-300 bg-white text-gray-900 focus-visible:ring-[#9565f5] ${fieldErrors.email ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                />
                {fieldErrors.email && (
              ...
              <div className="grid gap-1 sm:grid-cols-2 sm:gap-4">
                <div className="grid gap-1">
                  <Label htmlFor="firstName" className="text-gray-700">{translate('onboarding.form.firstName', 'First name')}</Label>
                  <Input
                    id="firstName"
                    name="firstName"
                    type="text"
                    ...
                    className={`border-gray-300 bg-white text-gray-900 focus-visible:ring-[#9565f5] ${fieldErrors.firstName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                  />
                ...
                <div className="grid gap-1">
                  <Label htmlFor="lastName" className="text-gray-700">{translate('onboarding.form.lastName', 'Last name')}</Label>
                  <Input
                    id="lastName"
                    name="lastName"
                    type="text"
                    ...
                    className={`border-gray-300 bg-white text-gray-900 focus-visible:ring-[#9565f5] ${fieldErrors.lastName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                  />
              ...
              <div className="grid gap-1">
                <Label htmlFor="organizationName" className="text-gray-700">{translate('onboarding.form.organizationName', 'Organization name')}</Label>
                <Input
                  id="organizationName"
                  ...
                  className={`border-gray-300 bg-white text-gray-900 focus-visible:ring-[#9565f5] ${fieldErrors.organizationName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                />
              ...
              <div className="grid gap-1">
                <Label htmlFor="password" className="text-gray-700">{translate('onboarding.form.password', 'Password')}</Label>
                <Input
                  id="password"
                  name="password"
                  type="password"
                  ...
                  className={`border-gray-300 bg-white text-gray-900 focus-visible:ring-[#9565f5] ${fieldErrors.password ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                />
              ...
              <div className="grid gap-1">
                <Label htmlFor="confirmPassword" className="text-gray-700">{translate('onboarding.form.confirmPassword', 'Confirm password')}</Label>
                <Input
                  id="confirmPassword"
                  ...
                  disabled={disabled}
                  autoComplete="new-password"
                  className={`border-gray-300 bg-white text-gray-900 focus-visible:ring-[#9565f5] ${fieldErrors.confirmPassword ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                />
              ...
              <label className="flex items-start gap-3 text-sm text-gray-500">
                <Checkbox
                  ...
                  className="data-[state=checked]:bg-[#9565f5] data-[state=checked]:border-[#9565f5]"
                />
                <span>
                  {translate('onboarding.form.termsLabel', 'I have read and accept the')}{' '}
                  <a className="underline hover:text-[#9565f5]" href="/terms" target="_blank" rel="noreferrer">
              ...
              <button
                type="submit"
                disabled={disabled}
                className="mt-2 h-11 rounded-full bg-[#9565f5] text-white font-medium transition hover:bg-[#8050e0] disabled:cursor-not-allowed disabled:opacity-60"
              >
                {submitting
