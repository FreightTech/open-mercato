...
export default async function FreightTechHome() {
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-8 lg:px-8">
        ...
        <header className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <Image
              ...
              height={48}
            />
            <span className="text-xl font-bold tracking-tight text-gray-900">FreightTech</span>
          </Link>
        ...
        <section className="mt-24 max-w-2xl lg:mt-32">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
            AI-powered, open source freight management system.
          </h1>

          <p className="mt-6 text-lg leading-relaxed text-gray-600 sm:text-xl">
            We help logistics teams streamline their operations and gain full visibility. One centralized platform powering shipment tracking, carrier management, route optimization, and beyond.
          </p>
