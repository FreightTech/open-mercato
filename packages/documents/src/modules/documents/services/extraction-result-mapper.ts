...
/**
 * Apply extraction pipeline results to a Document entity.
 * Sets all processing fields, normalizes consensus data, and maps type-specific fields.
 */
export function applyExtractionResult(document: Document, pipelineResult: DocumentProcessingResult): void {
