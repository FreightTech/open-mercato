...
const buildTablesCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Tables',
...
export function createTablesCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildTablesCrudOpenApi(options)
}
