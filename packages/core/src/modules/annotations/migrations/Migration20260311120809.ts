...
export class Migration20260311120809 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "contractor_bank_accounts" drop constraint "contractor_bank_accounts_contractor_id_foreign";`);
    ...
    this.addSql(`alter table "contractor_sop_comments" drop constraint "contractor_sop_comments_contractor_id_foreign";`);

    this.addSql(`alter table "fms_project_legs" drop constraint "fms_project_legs_carrier_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_client_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_consignee_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_controlling_agent_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_controlling_customer_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_creditor_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_notify_party_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_receiving_agent_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_sending_agent_id_foreign";`);
    ...
    this.addSql(`alter table "fms_document_pages" drop constraint "fms_document_pages_document_id_foreign";`);

    this.addSql(`alter table "fms_documents" drop constraint "fms_documents_parent_document_id_foreign";`);

    this.addSql(`alter table "fms_invoice_line_items" drop constraint "fms_invoice_line_items_invoice_id_foreign";`);

    this.addSql(`alter table "fms_invoice_pages" drop constraint "fms_invoice_pages_invoice_id_foreign";`);

    this.addSql(`alter table "fms_project_legs" drop constraint "fms_project_legs_destination_location_id_foreign";`);

    this.addSql(`alter table "fms_project_legs" drop constraint "fms_project_legs_origin_location_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_destination_location_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_origin_location_id_foreign";`);
    ...
    this.addSql(`alter table "fms_offer_lines" drop constraint "fms_offer_lines_calculation_id_foreign";`);

    this.addSql(`alter table "fms_offer_calculations" drop constraint "fms_offer_calculations_offer_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_offer_id_foreign";`);

    this.addSql(`alter table "fms_invoice_line_items" drop constraint "fms_invoice_line_items_product_id_foreign";`);

    this.addSql(`alter table "fms_air_units" drop constraint "fms_air_units_project_id_foreign";`);

    this.addSql(`alter table "fms_project_cargo" drop constraint "fms_project_cargo_project_id_foreign";`);

    this.addSql(`alter table "fms_project_invoices" drop constraint "fms_project_invoices_project_id_foreign";`);

    this.addSql(`alter table "fms_project_legs" drop constraint "fms_project_legs_project_id_foreign";`);

    this.addSql(`alter table "fms_project_lines" drop constraint "fms_project_lines_project_id_foreign";`);

    this.addSql(`alter table "fms_project_notes" drop constraint "fms_project_notes_project_id_foreign";`);

    this.addSql(`alter table "fms_road_units" drop constraint "fms_road_units_project_id_foreign";`);

    this.addSql(`alter table "fms_sea_containers" drop constraint "fms_sea_containers_project_id_foreign";`);

    this.addSql(`alter table "fms_offers" drop constraint "fms_offers_rfq_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint "fms_projects_rfq_id_foreign";`);

    this.addSql(`alter table "frc_console_cargo" drop constraint "frc_console_cargo_console_id_foreign";`);

    this.addSql(`alter table "frc_air_routing" drop constraint "frc_air_routing_offer_id_foreign";`);

    this.addSql(`alter table "frc_offer_lines" drop constraint "frc_offer_lines_offer_id_foreign";`);

    this.addSql(`alter table "frc_air_cargo" drop constraint "frc_air_cargo_rfq_id_foreign";`);

    this.addSql(`alter table "frc_consoles" drop constraint "frc_consoles_truck_preset_id_foreign";`);

    this.addSql(`alter table "frc_consoles" drop constraint "frc_consoles_truck_id_foreign";`);
    ...
    this.addSql(`alter table "shipment_tracking_events" drop constraint "shipment_tracking_events_tracking_job_id_fkey";`);

    this.addSql(`alter table "shipment_tracking_shipments" drop constraint "shipment_tracking_shipments_tracking_job_id_fkey";`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create table "contractor_sop_comments" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "category" text not null, "body" text not null, "author_user_id" uuid null, "author_name" text null, "is_pinned" bool not null default false, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "contractor_id" uuid not null, constraint "contractor_sop_comments_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "contractors" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "short_name" text null, "official_name" text null, "parent_id" uuid null, "tax_id" text null, "regon" text null, "krs" text null, "registration_date" text null, "pkd_main_code" text null, "pkd_main_description" text null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "role_type_ids" jsonb null, constraint "contractors_pkey" primary key ("id"));`);
    ...
    this.addSql(`alter table "entity_indexes" add constraint "entity_indexes_upsert_idx" unique ("entity_type", "entity_id", "organization_id_coalesced");`);
    ...
    this.addSql(`create table "fms_carriers" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "code" text not null, "name" text not null, "carrier_type" text not null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, constraint "fms_carriers_pkey" primary key ("id"));`);
    this.addSql(`create index "fms_carriers_scope_idx" on "fms_carriers" ("organization_id", "tenant_id");`);

    this.addSql(`create table "fms_document_pages" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "document_id" uuid not null, "page_number" int4 not null, "storage_path" text not null, "storage_driver" text not null default 'local', "width" int4 null, "height" int4 null, "file_size" int4 null, "created_at" timestamptz(6) not null default now(), constraint "fms_document_pages_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_documents" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "category" text not null default 'other', "description" text null, "attachment_id" uuid not null, "related_entity_id" uuid null, "related_entity_type" text null, "extracted_data" jsonb null, "processed_at" timestamptz(6) null, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, "processing_status" text not null default 'pending', "processing_result" jsonb null, "consensus_confidence" numeric(3,2) null, "consensus_recommendation" text null, "document_type" text null, "document_type_confidence" int4 null, "document_number" text null, "document_date" date null, "bl_number" text null, "booking_number" text null, "container_numbers" jsonb null, "vessel_name" text null, "voyage_number" text null, "port_of_loading" text null, "port_of_discharge" text null, "currency" text null, "seller_name" text null, "buyer_name" text null, "total_gross_amount" numeric(18,2) null, "raw_text" text null, "document_data" jsonb null, "edited_by" uuid null, "edited_at" timestamptz(6) null, "parent_document_id" uuid null, "mbl_number" text null, constraint "fms_documents_pkey" primary key ("id"));`);
    ...
    this.addSql(`create index "fms_documents_related_entity_idx" on "fms_documents" ("related_entity_id", "related_entity_type");`);
    this.addSql(`create index "fms_documents_scope_idx" on "fms_documents" ("organization_id", "tenant_id");`);

    this.addSql(`create table "fms_email_settings" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "company_name" text null, "company_logo_url" text null, "primary_color" text not null default '#1a365d', "accent_color" text not null default '#f7fafc', "contact_email" text null, "contact_phone" text null, "website_url" text null, "footer_text" text null, "footer_disclaimer" text null, "from_name" text null, "from_email" text null, "reply_to_email" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, constraint "fms_email_settings_pkey" primary key ("id"));`);
    this.addSql(`alter table "fms_email_settings" add constraint "fms_email_settings_scope_unique" unique ("organization_id", "tenant_id");`);

    this.addSql(`create table "fms_email_templates" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "template_type" text not null, "subject_template" text not null, "html_template" text not null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, constraint "fms_email_templates_pkey" primary key ("id"));`);
    this.addSql(`create index "fms_email_templates_org_tenant_idx" on "fms_email_templates" ("organization_id", "tenant_id");`);
    this.addSql(`alter table "fms_email_templates" add constraint "fms_email_templates_scope_type_unique" unique ("organization_id", "tenant_id", "template_type");`);

    this.addSql(`create table "fms_invoice_line_items" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "invoice_id" uuid not null, "line_number" int4 not null, "description" text not null, "quantity" numeric(18,4) not null default '1', "unit" text null, "unit_price_net" numeric(18,4) not null default '0', "vat_rate" numeric(5,2) not null default '0', "net_amount" numeric(18,2) not null default '0', "vat_amount" numeric(18,2) not null default '0', "gross_amount" numeric(18,2) not null default '0', "product_id" uuid null, "charge_code_match_confidence" int4 null, "raw_description" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, constraint "fms_invoice_line_items_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_locations" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "code" text not null, "name" text not null, "product_type" text not null, "locode" text null, "port_id" uuid null, "lat" float8 null, "lng" float8 null, "city" text null, "country" text null, "contractor_id" uuid null, "address_line1" text null, "address_line2" text null, "state" text null, "postal_code" text null, "is_primary" bool not null default false, "is_active" bool not null default true, "google_place_id" text null, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, constraint "fms_locations_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_offer_calculations" ("id" uuid not null default gen_random_uuid(), "offer_id" uuid not null, "organization_id" uuid not null, "tenant_id" uuid not null, "calculation_number" int4 not null default 1, "label" text null, "containers" jsonb null, "origin_location_id" uuid null, "destination_location_id" uuid null, "place_of_loading_id" uuid null, "place_of_delivery_id" uuid null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "fms_offer_calculations_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_offer_lines" ("id" uuid not null default gen_random_uuid(), "calculation_id" uuid not null, "organization_id" uuid not null, "tenant_id" uuid not null, "line_number" int4 not null default 0, "product_id" uuid null, "product_name" text null, "charge_code" text null, "charge_basis" text null, "currency_code" text not null default 'USD', "rate" numeric(18,4) not null default '0', "buy_price" numeric(18,4) not null default '0', "sell_price" numeric(18,4) not null default '0', "container_type" text null, "is_enabled" bool not null default false, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "fms_offer_lines_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_offers" ("id" uuid not null default gen_random_uuid(), "rfq_id" uuid null, "organization_id" uuid not null, "tenant_id" uuid not null, "offer_number" text not null, "version" int4 not null default 1, "status" text not null default 'draft', "direction" text null, "transport_mode" text null, "cargo_type" text null, "valid_until" timestamptz(6) null, "payment_terms" text null, "special_terms" text null, "customer_notes" text null, "notes" text null, "superseded_by_id" uuid null, "assigned_to_id" uuid null, "operational_guardian_id" uuid null, "business_guardian_id" uuid null, "document_id" uuid null, "sent_at" timestamptz(6) null, "sent_to_email" text null, "exchange_rates" jsonb null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "contractor_id" uuid null, "contact_person_id" uuid null, "billing_address_id" uuid null, constraint "fms_offers_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_products" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "charge_code" text null, "charge_unit" text null, "transport_mode" text null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, "cost_price" numeric(18,4) null, constraint "fms_products_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_project_lines" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "project_id" uuid not null, "line_number" int4 not null default 0, "source_offer_line_id" uuid null, "source_type" text not null default 'manual', "product_id" uuid null, "price_id" uuid null, "product_name" text not null, "charge_code" text null, "container_size" text null, "charge_category" text null, "charge_unit" text null, "container_type" text null, "quantity" numeric(18,4) not null default '1', "currency_code" text not null default 'USD', "sold_unit_price" numeric(18,4) not null default '0', "sold_amount" numeric(18,4) not null default '0', "actual_unit_cost" numeric(18,4) null, "actual_cost" numeric(18,4) null, "notes" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "estimated_unit_cost" numeric(18,4) null, "estimated_cost" numeric(18,4) null, "actual_sell_unit_price" numeric(18,4) null, "actual_sell_amount" numeric(18,4) null, constraint "fms_project_lines_pkey" primary key ("id"));`);
    this.addSql(`create index "fms_project_lines_org_tenant_idx" on "fms_project_lines" ("organization_id", "tenant_id");`);
    this.addSql(`create index "fms_project_lines_project_idx" on "fms_project_lines" ("project_id");`);

    this.addSql(`create table "fms_project_notes" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "project_id" uuid not null, "body" text not null, "author_user_id" uuid null, "author_name" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "fms_project_notes_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_projects" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "project_number" text not null, "client_id" uuid null, "rfq_id" uuid null, "offer_id" uuid null, "shipment_id" uuid null, "workflow_instance_id" uuid null, "current_step" text null, "workflow_context" jsonb null, "shipment_type" text not null, "direction" text not null, "cargo_type" text not null, "incoterm" text null, "transport_modes" jsonb null, "origin_location_id" uuid null, "destination_location_id" uuid null, "place_of_loading_id" uuid null, "place_of_discharge_id" uuid null, "origin_address" text null, "destination_address" text null, "project_date" timestamptz(6) not null, "requested_pickup_date" timestamptz(6) null, "requested_delivery_date" timestamptz(6) null, "etd" timestamptz(6) null, "eta" timestamptz(6) null, "atd" timestamptz(6) null, "ata" timestamptz(6) null, "cargo_ready_date" timestamptz(6) null, "vgm_cutoff_date" timestamptz(6) null, "doc_cutoff_date" timestamptz(6) null, "gate_in_date" timestamptz(6) null, "gate_close_date" timestamptz(6) null, "carrier_id" uuid null, "client_reference" text null, "internal_reference" text null, "commodity_description" text null, "hs_code" text null, "container_count" int4 null, "transport_unit_count" int4 null, "total_gross_weight" numeric(18,4) null, "total_volume" numeric(18,4) null, "weight_unit" text null, "volume_unit" text null, "currency_code" text not null default 'USD', "estimated_cost" numeric(18,4) null, "requires_insurance" bool not null default false, "requires_customs_brokerage" bool not null default false, "is_hazardous" bool not null default false, "hazmat_details" text null, "special_instructions" text null, "internal_notes" text null, "container_mode" text null, "service_level" text null, "bl_number" text null, "bl_type" text null, "release_type" text null, "notify_party_id" uuid null, "controlling_agent_id" uuid null, "controlling_customer_id" uuid null, "sending_agent_id" uuid null, "receiving_agent_id" uuid null, "agents_reference" text null, "booking_number" text null, "operator_id" uuid null, "operator_name" text null, "sales_person_id" uuid null, "sales_person_name" text null, "shipper_id" uuid null, "consignee_id" uuid null, "goods_value" numeric(18,2) null, "goods_value_currency" text null, "insurance_value" numeric(18,2) null, "insurance_value_currency" text null, "is_domestic" bool not null default false, "additional_terms" text null, "creditor_id" uuid null, "payment_terms" text null, "invoicing_status" text null, "ct_status" text null, "e_freight_status" text null, "charges_apply" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "fms_projects_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_rfqs" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "title" text null, "description" text null, "origin" text null, "destination" text null, "origin_location_id" uuid null, "destination_location_id" uuid null, "place_of_loading" text null, "place_of_loading_id" uuid null, "place_of_delivery" text null, "place_of_delivery_id" uuid null, "container_count" int4 null, "direction" text null, "transport_mode" text null, "cargo_type" text null, "company_name" text null, "contact_person" text null, "context" text null, "status" text not null default 'incoming', "assigned_to_id" uuid null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "contractor_id" uuid null, "contact_person_id" uuid null, constraint "fms_rfqs_pkey" primary key ("id"));`);
    this.addSql(`create index "fms_rfqs_org_tenant_idx" on "fms_rfqs" ("organization_id", "tenant_id");`);

    this.addSql(`create table "fms_road_units" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "project_id" uuid not null, "vehicle_type" text not null, "truck_number" text null, "trailer_number" text null, "driver_name" text null, "driver_phone" text null, "cmr_number" text null, "booking_number" text null, "carrier_name" text null, "carrier_contact" text null, "origin_address" text null, "destination_address" text null, "pickup_date" timestamptz(6) null, "delivery_date" timestamptz(6) null, "actual_pickup" timestamptz(6) null, "actual_delivery" timestamptz(6) null, "pieces" int4 null, "gross_weight" numeric(18,4) null, "pallet_spaces" int4 null, "loading_meters" numeric(18,4) null, "status" text not null default 'not_ready', "is_hazardous" bool not null default false, "notes" text null, "unloading_notes" text null, "weighing_status" text null, "rate" numeric(18,4) null, "rate_currency" text null default 'PLN', "customs_status" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "fms_road_units_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_teams" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "fms_teams_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_user_teams" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "team_id" uuid null, "user_id" uuid not null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, constraint "fms_user_teams_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "frc_air_cargo" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "rfq_id" uuid null, "name" text not null, "number_of_pieces" int4 not null default 1, "stackable_type" text not null default 'fully_stackable', "length_cm" numeric(12,2) null, "width_cm" numeric(12,2) null, "height_cm" numeric(12,2) null, "volume_m3" numeric(18,4) not null default '0', "actual_weight_kg" numeric(18,4) not null default '0', "chargeable_weight_kg" numeric(18,4) not null default '0', "loading_metres" numeric(18,4) not null default '0', "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "frc_air_cargo_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "frc_console_cargo" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "console_id" uuid not null, "air_cargo_id" uuid not null, "quantity" int4 not null default 1, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "frc_console_cargo_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "frc_offer_lines" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "offer_id" uuid not null, "source_air_cargo_id" uuid null, "name" text not null, "number_of_pieces" int4 not null default 1, "stackable_type" text not null default 'fully_stackable', "length_cm" numeric(12,2) null, "width_cm" numeric(12,2) null, "height_cm" numeric(12,2) null, "volume_m3" numeric(18,4) not null default '0', "actual_weight_kg" numeric(18,4) not null default '0', "chargeable_weight_kg" numeric(18,4) not null default '0', "loading_metres" numeric(18,4) not null default '0', "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "frc_offer_lines_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "frc_rfqs" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "account_id" uuid null, "contact_id" uuid null, "sales_stage" text not null default 'received', "probability" int4 not null default 0, "amount" numeric(18,4) null, "currency_code" text not null default 'EUR', "delivery_status" text not null default 'awaiting', "is_delayed" bool not null default false, "origin_type" text not null default 'airport', "origin_airport_id" uuid null, "destination_airport_id" uuid null, "shipment_ready_date" date null, "required_at_destination_date" date null, "loose_or_unitised" text null, "target_rate" numeric(18,4) null, "product" text null, "commodity" text null, "total_pieces" int4 not null default 0, "total_volume" numeric(18,4) not null default '0', "total_actual_weight" numeric(18,4) not null default '0', "total_chargeable_weight" numeric(18,4) not null default '0', "total_loading_metres" numeric(18,4) not null default '0', "description" text null, "assigned_to_id" uuid null, "request_date" timestamptz(6) not null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "frc_rfqs_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "frc_truck_presets" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "width" int4 not null, "length" int4 not null, "height" int4 not null, "max_weight" int4 not null, "volume" numeric(10,2) not null, "is_active" bool not null default true, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), "deleted_at" timestamptz(6) null, constraint "frc_truck_presets_pkey" primary key ("id"));`);
    this.addSql(`create index "frc_truck_presets_org_tenant_idx" on "frc_truck_presets" ("organization_id", "tenant_id");`);

    this.addSql(`create table "frc_trucks" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "frc_trucks_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "mikro_orm_migrations_contractors" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);
    ...
    this.addSql(`create table "mikro_orm_migrations_email_templates" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);
    ...
    this.addSql(`create table "mikro_orm_migrations_fms_documents" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_fms_financials" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_fms_locations" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_fms_offers" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_fms_products" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_fms_projects" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_fms_quotes" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_fms_teams" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_fms_tracking" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_frc_airports" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_frc_console" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_frc_offers" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_frc_projects" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_frc_rfqs" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);

    this.addSql(`create table "mikro_orm_migrations_frc_trucks" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);
    ...
    this.addSql(`create table "mikro_orm_migrations_shipment_tracking" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);
    ...
    this.addSql(`create table "shipment_tracking_bic_configs" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "is_enabled" bool not null default false, "username" text not null default '', "password" text not null default '', "base_url" text not null default 'https://api.bic-code.org', "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), constraint "shipment_tracking_bic_configs_pkey" primary key ("id"));`);
    this.addSql(`create index "st_bic_configs_org_tenant_idx" on "shipment_tracking_bic_configs" ("organization_id", "tenant_id");`);
    this.addSql(`alter table "shipment_tracking_bic_configs" add constraint "st_bic_configs_scope_unique" unique ("organization_id", "tenant_id");`);

    this.addSql(`create table "shipment_tracking_carrier_configs" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "carrier_code" text not null, "api_endpoint" text null, "auth_config" jsonb null, "rate_limit_requests" int4 not null default 60, "rate_limit_window_seconds" int4 not null default 60, "is_active" bool not null default true, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), "deleted_at" timestamptz(6) null, "company_name" text null, constraint "shipment_tracking_carrier_configs_pkey" primary key ("id"));`);
    this.addSql(`alter table "shipment_tracking_carrier_configs" add constraint "st_carrier_configs_code_uniq" unique ("organization_id", "tenant_id", "carrier_code");`);
    this.addSql(`alter table "shipment_tracking_carrier_configs" add constraint "st_carrier_configs_name_company_uniq" unique ("organization_id", "tenant_id", "carrier_code", "company_name");`);
    ...
    this.addSql(`create table "shipment_tracking_companies" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "description" text null, "is_active" bool not null default true, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), "deleted_at" timestamptz(6) null, constraint "shipment_tracking_companies_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "shipment_tracking_events" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "event_type" text not null, "event_code" text not null, "event_classifier_code" text null, "event_date_time" timestamptz(6) not null, "event_date_time_offset" text null, "description" text null, "location_name" text null, "location_unlocode" text null, "location_country" text null, "vessel_name" text null, "vessel_imo" text null, "voyage_number" text null, "raw_data" jsonb null, "created_at" timestamptz(6) not null default now(), "equipment_reference" text null, "iso_equipment_code" text null, "empty_indicator_code" text null, "is_transshipment_move" bool null, "facility_code" text null, "facility_code_list_provider" text null, "facility_type_code" text null, "latitude" float4 null, "longitude" float4 null, "transport_call_reference" text null, "mode_of_transport" text null, "carrier_service_code" text null, "carrier_export_voyage_number" text null, "carrier_import_voyage_number" text null, "universal_service_reference" text null, "universal_export_voyage_reference" text null, "universal_import_voyage_reference" text null, "port_visit_reference" text null, "related_document_references" jsonb null, "event_created_date_time" timestamptz(6) null, "retracted_event_id" text null, "publisher_name" text null, "publisher_role" text null, "delay_reason_code" text null, "change_remark" text null, "seals" jsonb null, "tracking_job_id" uuid not null, "source" text not null default 'dcsa', "source_event_id" text null, "facility_address" text null, constraint "shipment_tracking_cargo_events_pkey" primary key ("id"));`);
    this.addSql(`create index "st_events_equipment_ref_idx" on "shipment_tracking_events" ("equipment_reference");`);
    this.addSql(`create index "st_events_event_date_time_idx" on "shipment_tracking_events" ("event_date_time");`);
    this.addSql(`create index "st_events_org_tenant_idx" on "shipment_tracking_events" ("organization_id", "tenant_id");`);
    this.addSql(`CREATE UNIQUE INDEX st_events_source_event_uniq ON public.shipment_tracking_events USING btree (tracking_job_id, source, source_event_id) WHERE (source_event_id IS NOT NULL);`);
    this.addSql(`create index "st_events_tracking_job_idx" on "shipment_tracking_events" ("tracking_job_id");`);

    this.addSql(`create table "shipment_tracking_jobs" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "carrier_code" text not null, "reference_type" text not null, "reference_value" text not null, "status" text not null default 'active', "schedule" jsonb null, "next_poll_at" timestamptz(6) null, "last_poll_at" timestamptz(6) null, "retry_count" int4 not null default 0, "error_history" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), "deleted_at" timestamptz(6) null, "origin_unlocode" varchar(5) null, "destination_unlocode" varchar(5) null, constraint "shipment_tracking_jobs_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "shipment_tracking_shipments" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "status" text not null default 'ORDERED', "carrier_code" text null, "container_number" text null, "booking_number" text null, "bol_number" text null, "vessel_name" text null, "vessel_imo" text null, "event_count" int4 not null default 0, "extra" jsonb null, "is_active" bool not null default true, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), "deleted_at" timestamptz(6) null, "created_by_user_id" uuid null, "company_name" text null, "tracking_job_id" uuid null, "voyage_number" text null, "last_event_at" timestamptz(6) null, "etd_timestamps" jsonb null, "eta_timestamps" jsonb null, "atd_timestamps" jsonb null, "ata_timestamps" jsonb null, "route_stops" jsonb null, "cargo_events" jsonb null, "origin_location" jsonb null, "destination_location" jsonb null, constraint "shipment_tracking_shipments_pkey" primary key ("id"));`);
    ...
    this.addSql(`create index "st_shipments_tracking_job_idx" on "shipment_tracking_shipments" ("tracking_job_id");`);

    this.addSql(`create table "shipment_tracking_webhook_deliveries" ("id" uuid not null default gen_random_uuid(), "webhook_id" uuid not null, "event_type" text not null, "status" text not null default 'pending', "retry_count" int4 not null default 0, "next_retry_at" timestamptz(6) null, "payload" jsonb not null, "response_status" int4 null, "response_body" text null, "error_message" text null, "created_at" timestamptz(6) not null default now(), constraint "shipment_tracking_webhook_deliveries_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "shipment_tracking_webhooks" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "url" text not null, "events_subscribed" jsonb not null, "hmac_secret" text null, "is_active" bool not null default true, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), "deleted_at" timestamptz(6) null, constraint "shipment_tracking_webhooks_pkey" primary key ("id"));`);
    ...
    this.addSql(`alter table "contractor_addresses" add constraint "contractor_addresses_contractor_id_foreign" foreign key ("contractor_id") references "contractors" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "contractor_bank_accounts" add constraint "contractor_bank_accounts_contractor_id_foreign" foreign key ("contractor_id") references "contractors" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "contractor_contacts" add constraint "contractor_contacts_contractor_id_foreign" foreign key ("contractor_id") references "contractors" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "contractor_credit_limits" add constraint "contractor_credit_limits_contractor_id_foreign" foreign key ("contractor_id") references "contractors" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "contractor_payment_terms" add constraint "contractor_payment_terms_contractor_id_foreign" foreign key ("contractor_id") references "contractors" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "contractor_sop_comments" add constraint "contractor_sop_comments_contractor_id_foreign" foreign key ("contractor_id") references "contractors" ("id") on update cascade on delete no action;`);
    ...
    this.addSql(`alter table "fms_air_units" add constraint "fms_air_units_project_id_foreign" foreign key ("project_id") references "fms_projects" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "fms_document_pages" add constraint "fms_document_pages_document_id_foreign" foreign key ("document_id") references "fms_documents" ("id") on update no action on delete cascade;`);
    ...
    this.addSql(`alter table "fms_offer_calculations" add constraint "fms_offer_calculations_offer_id_foreign" foreign key ("offer_id") references "fms_offers" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "fms_offer_lines" add constraint "fms_offer_lines_calculation_id_foreign" foreign key ("calculation_id") references "fms_offer_calculations" ("id") on update cascade on delete no action;`);
    ...
    this.addSql(`alter table "fms_project_cargo" add constraint "fms_project_cargo_project_id_foreign" foreign key ("project_id") references "fms_projects" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "fms_project_invoices" add constraint "fms_project_invoices_project_id_foreign" foreign key ("project_id") references "fms_projects" ("id") on update cascade on delete no action;`);
    ...
    this.addSql(`alter table "fms_project_legs" add constraint "fms_project_legs_project_id_foreign" foreign key ("project_id") references "fms_projects" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "fms_project_lines" add constraint "fms_project_lines_project_id_foreign" foreign key ("project_id") references "fms_projects" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "fms_project_notes" add constraint "fms_project_notes_project_id_foreign" foreign key ("project_id") references "fms_projects" ("id") on update cascade on delete no action;`);
    ...
    this.addSql(`alter table "fms_projects" add constraint "fms_projects_controlling_agent_id_foreign" foreign key ("controlling_agent_id") references "contractors" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "fms_projects" add constraint "fms_projects_controlling_customer_id_foreign" foreign key ("controlling_customer_id") references "contractors" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "fms_projects" add constraint "fms_projects_creditor_id_foreign" foreign key ("creditor_id") references "contractors" ("id") on update cascade on delete set null;`);
    ...
    this.addSql(`alter table "fms_projects" add constraint "fms_projects_notify_party_id_foreign" foreign key ("notify_party_id") references "contractors" ("id") on update cascade on delete set null;`);
    ...
    this.addSql(`alter table "fms_projects" add constraint "fms_projects_receiving_agent_id_foreign" foreign key ("receiving_agent_id") references "contractors" ("id") on update cascade on delete set null;`);
    ...
    this.addSql(`alter table "fms_projects" add constraint "fms_projects_sending_agent_id_foreign" foreign key ("sending_agent_id") references "contractors" ("id") on update cascade on delete set null;`);
    ...
    this.addSql(`alter table "fms_road_units" add constraint "fms_road_units_project_id_foreign" foreign key ("project_id") references "fms_projects" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "fms_sea_containers" add constraint "fms_sea_containers_project_id_foreign" foreign key ("project_id") references "fms_projects" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "frc_air_cargo" add constraint "frc_air_cargo_rfq_id_foreign" foreign key ("rfq_id") references "frc_rfqs" ("id") on update cascade on delete set null;`);

    this.addSql(`alter table "frc_air_routing" add constraint "frc_air_routing_offer_id_foreign" foreign key ("offer_id") references "frc_offers" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "frc_console_cargo" add constraint "frc_console_cargo_console_id_foreign" foreign key ("console_id") references "frc_consoles" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "frc_consoles" add constraint "frc_consoles_truck_id_foreign" foreign key ("truck_id") references "frc_trucks" ("id") on update cascade on delete no action;`);
    ...
    this.addSql(`alter table "frc_offer_lines" add constraint "frc_offer_lines_offer_id_foreign" foreign key ("offer_id") references "frc_offers" ("id") on update cascade on delete no action;`);
    ...
    this.addSql(`alter table "shipment_tracking_events" add constraint "shipment_tracking_events_tracking_job_id_fkey" foreign key ("tracking_job_id") references "shipment_tracking_jobs" ("id") on update no action on delete cascade;`);

    this.addSql(`alter table "shipment_tracking_shipments" add constraint "shipment_tracking_shipments_tracking_job_id_fkey" foreign key ("tracking_job_id") references "shipment_tracking_jobs" ("id") on update no action on delete set null;`);

    this.addSql(`alter table "shipment_tracking_webhook_deliveries" add constraint "shipment_tracking_webhook_deliveries_webhook_id_foreign" foreign key ("webhook_id") references "shipment_tracking_webhooks" ("id") on update cascade on delete no action;`);
