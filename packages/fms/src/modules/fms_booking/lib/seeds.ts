...
import type { Incoterm, ShipmentType, Direction, CargoType, WeightUnit, BookingStatus } from '../data/types'

export type BookingSeedScope = {
  tenantId: string
...
export const defaultBookings: BookingSeed[] = [
  {
    bookingNumber: 'EXP/FCL/00001/2026/DEMO',
    shipmentType: 'EXP',
    direction: 'export',
    cargoType: 'fcl',
    incoterm: 'FOB',
  ...
  {
    bookingNumber: 'IMP/LCL/00001/2026/DEMO',
    shipmentType: 'IMP',
    direction: 'import',
    cargoType: 'lcl',
    incoterm: 'CIF',
  ...
  {
    bookingNumber: 'EXP/FCL/00002/2026/DEMO',
    shipmentType: 'EXP',
    direction: 'export',
    cargoType: 'fcl',
    incoterm: 'EXW',
...
export async function seedBookings(
  ...
  for (const seed of defaultBookings) {
    const existing = await em.findOne(Booking, {
