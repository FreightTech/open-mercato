# FMS Booking - User Stories

## Overview
User stories for the complete booking lifecycle, from initial creation through financial close.

---

## Phase 1: Booking Creation & Planning

### Story 1: Create a New Booking
**As a** booking coordinator
**I want to** create a new freight booking from scratch
**So that** I can start planning a shipment for my customer

**Acceptance Criteria:**
- I can click "New Booking" button from the bookings list
- System auto-generates a booking number (e.g., `EXP/FCL/00123/2026/ABC`)
...
- Booking starts in "Draft" status
- System creates a workflow instance to track the booking lifecycle

**Example:**
> Sarah, a booking coordinator, receives an email from ABC Corp requesting shipping of 2 containers from Shanghai to Los Angeles. She clicks "New Booking", selects ABC Corp as the client, enters their PO number "PO-12345", selects "EXP" (Export) and "FCL" (Full Container Load). System creates booking `EXP/FCL/00001/2026/ABC`.

---

### Story 2: Create Booking from Accepted Offer
**As a** booking coordinator
**I want to** create a booking directly from an accepted offer
**So that** I don't have to re-enter information that's already in the pricing proposal

**Acceptance Criteria:**
- I can click "Create Booking" button from accepted offer detail view
...
- System links booking to both the offer and parent quote for reference
- I can modify the pre-filled information if needed
- Booking inherits offer reference number

**Example:**
> Mike reviews Offer OFF-2026-001 (from Quote Q-2026-001) that was accepted by XYZ Ltd for 2x40HC Shanghai→LA. He clicks "Create Booking" on the offer, and the system automatically fills in customer info, 2x40HC containers, FOB Shanghai terms, and the agreed pricing of $4,200. He just needs to add the actual container numbers and pickup date.
...
- System shows me an SLA countdown (due in 2 hours from booking creation)
- If SLA is approaching, system highlights booking in "Action Required" list
- Workflow advances to "Add Cargo Details" step

**Example:**
> After adding 3 route legs, Sarah clicks "Complete Planning". System confirms all legs are valid and moves the booking to the cargo entry phase.
...
**Acceptance Criteria:**
- I can add multiple containers to the booking
...
**Example:**
> Tom adds 2 containers to the booking:
...
- System validates:
  - FCL bookings have at least 1 container
  - LCL bookings have at least 1 cargo item
...
### Story 8: Automated Booking Validation
**As a** booking coordinator
**I want to** the system to automatically validate my booking
...
**I want to** review and confirm the booking details
**So that** I can approve the shipment plan before execution

**Acceptance Criteria:**
- I receive an email with booking summary
- Email includes: pickup date, delivery date, route, cargo details, pricing estimate
- I can click "Confirm Booking" link in email (or confirm via customer portal)
- System has a 48-hour timeout - if I don't respond, booking auto-cancels
- When I confirm, workflow advances to "Booking Confirmed"

**Example:**
> ABC Corp's logistics manager receives booking review email, checks the details match their requirements, and clicks "Confirm Booking" within 24 hours.
...
**So that** I can follow up or cancel the booking

**Acceptance Criteria:**
- System sends reminder email to customer after 24 hours (50% of timeout)
- If 48 hours pass without confirmation, system auto-cancels booking
...
- Cancelled bookings move to "Cancelled" status with reason "Customer timeout"

**Example:**
> After 26 hours, XYZ Ltd hasn't responded. System sends reminder. At 48 hours still no response - system cancels booking and notifies Mike to follow up.

---

## Phase 5: Carrier Booking & Execution

### Story 11: Automatic Carrier Booking (System)
**As a** booking coordinator
...
**Acceptance Criteria:**
- When customer confirms, system automatically sends booking requests to all carriers in parallel
...
- System stores carrier booking reference numbers
- If ANY leg fails, system automatically cancels all confirmed legs (compensation)

**Example:**
> Customer confirms booking. System simultaneously books:
...
### Story 12: Handle Carrier Booking Failure
**As a** booking coordinator
**I want to** be notified when carrier booking fails
...
**Example:**
> Maersk API returns "No capacity available" for requested sailing. System cancels the truck bookings and alerts Sarah. She finds alternative carrier CMA CGM, manually books vessel "CMA LIBERTY", and enters booking reference in system.
...
- Shipment inherits key data from booking:
  ...
  - ETD/ETA dates
- Booking links to shipment via shipmentId field
- System emits "booking.legs_confirmed" event
- Booking status changes to "In Transit"

**Example:**
> All 3 carriers confirm. System creates Shipment S-2026-00123 linking to Booking EXP/FCL/00001/2026/ABC. Emma can now use the shipment tracking dashboard to monitor progress.
...
**So that** the booking can move to completion

**Acceptance Criteria:**
- I can click "Confirm Delivery" button from booking detail view
- System asks for:
...
- Workflow advances to "Booking Completed" step
...
**I want to** the system to automatically flag completed bookings for review
**So that** I can perform monthly financial close efficiently

**Acceptance Criteria:**
- System runs monthly on 8th of each month at 00:00
- System queries all bookings with:
  - Status = "Booking Completed"
  - Completed date in previous month
- System sends "financial.close_initiated" signal to each booking's workflow
- System creates "Financial Close Dashboard" showing:
  - All bookings pending review (grouped by coordinator)
...
**Example:**
> On February 8, 2026, system finds 45 bookings completed in January. It flags them all for review and emails Janet (financial controller): "45 January bookings ready for financial close."

---

### Story 18: Review Booking Financials
**As a** financial controller
...
**Example:**
> Janet reviews Booking EXP/FCL/00001/2026/ABC:
> - Estimated: $8,500
...
- System updates:
  - Booking status to "Financially Closed"
  - Final margin and profit figures locked
  - Booking marked as reviewed and approved
...
- Booking moves to END of workflow

**Example:**
> After verifying all invoices are correct, Janet approves financial close for 45 January bookings. System generates January 2026 Controlling Report showing total revenue $472,000, costs $398,000, profit $74,000, avg margin 15.7%.

---

### Story 20: Handle Missing Invoices
**As a** financial controller
**I want to** flag bookings with missing invoices
...
- I can click "Flag for Follow-up" to:
  ...
  - Set reminder date
- Booking remains in "Financial Close" step (not approved)
- I can approve other bookings and return to flagged ones later
...
### Story 21: Cancel Booking (Before Confirmation)
**As a** booking coordinator
**I want to** cancel a booking that's not yet confirmed
**So that** I can remove bookings that are no longer needed

**Acceptance Criteria:**
- I can click "Cancel Booking" button from any status before "Booking Confirmed"
- System asks for cancellation reason
- System immediately:
  - Marks booking status as "Cancelled"
...
- Cancelled bookings appear in "Cancelled" perspective
...
### Story 22: Cancel Booking (After Carrier Booking)
**As a** booking coordinator
**I want to** cancel a booking after carriers were booked
**So that** I can handle customer cancellations properly

**Acceptance Criteria:**
- I can click "Cancel Booking" button (even after carriers confirmed)
- System shows WARNING: "This will cancel carrier bookings. Are you sure?"
- If I confirm, system:
...
**Example:**
> Customer cancels shipment 1 day before pickup. Mike cancels booking, system automatically cancels truck booking (free), ship booking ($500 cancellation fee), and second truck (free). Mike invoices customer for $500 carrier cancellation fee + admin fee.
...
**As a** booking coordinator
**I want to** upload required shipping documents to the booking
**So that** I have all documentation organized for customs, delivery, and billing

**Acceptance Criteria:**
- I can upload documents from booking detail view
...
**Example:**
> Sarah uploads the carrier's Bill of Lading (BOL-MAEU-12345678.pdf), selects category "Bill of Lading", enters BOL number. System adds it to the booking using fms_documents module and checks off "BOL" on the required documents checklist.

**Technical Note:** This feature integrates with the existing `fms_documents` module. Documents are linked to bookings using `relatedEntityType = 'fms_booking:booking'` and `relatedEntityId = bookingId`.
...
**As a** booking coordinator
**I want to** upload the Bill of Lading received from the carrier and link it to the booking
...
- System links document to booking with category "Bill of Lading"
...
**Example:**
> Emma receives BOL (MAEU-BOL-12345678.pdf) from Maersk via email. She uploads it to the booking, system auto-detects BOL number from PDF, and marks document as "Bill of Lading". Document is now available for sharing with customer and customs broker.
...
- Dashboard shows all bookings with missing documents

**Example:**
> Import booking shows checklist: ✅ BOL, ✅ Commercial Invoice, ❌ ISF Filing (due in 18 hours). System alerts Sarah to submit ISF urgently.

---

## Phase 10: Booking Amendments

### Story 27: Request Booking Amendment
**As a** booking coordinator
**I want to** request changes to a confirmed booking
...
- Booking stays in "Amendment Pending" status
- Original data is preserved for audit trail

**Example:**
> Customer wants to add 1 more container to confirmed booking. Sarah clicks "Request Amendment", changes container count from 2 to 3. System creates amendment request and marks booking as "Amendment Pending".
...
**So that** booking data is updated only when carrier confirms
...
- If carrier confirms, I can:
  ...
  - Approve amendment → system updates booking data
...
### Story 30: Cancel and Rebook (Amendment Not Possible)
**As a** booking coordinator
**I want to** cancel original booking and create new one when amendment is not possible
**So that** I can handle major customer changes

**Acceptance Criteria:**
- If carrier rejects amendment (e.g., no space for extra containers), I can click "Cancel and Rebook"
- System:
  - Cancels original booking (with reason: "Rebooked due to customer changes")
  - Creates new booking with amended details
...
- I can notify customer of cancellation fees and new booking confirmation
- Original booking marked as "Cancelled - Rebooked" (not just "Cancelled")

**Example:**
> Customer wants to change ETD by 2 weeks - carrier says must cancel and rebook. Sarah clicks "Cancel and Rebook", system cancels original (fee $500), creates new booking for new date, transfers all documents. Customer invoiced $500 cancellation fee.
...
**Acceptance Criteria:**
- I can click "Report Exception" from booking detail
...
**As a** booking coordinator
**I want to** manage bookings with significant delays
...
**As a** booking coordinator (or billing specialist)
...
- Customer receives email: "Invoice #INV-2026-00123 for Booking EXP/FCL/00001/2026/ABC - Amount $5,616 due by Feb 28"
...
**As a** accounting clerk (or booking coordinator)
...
- Payment appears on booking financial summary
...
**As a** booking coordinator
**I want to** match received carrier invoices to bookings
...
- Once all carrier invoices are matched, booking is ready for financial close

**Example:**
> Maersk invoice arrives for $3,180 (vs. estimate $3,200). Sarah uploads PDF, system extracts booking reference, auto-matches to booking. She categorizes as "Ocean Freight - Main Carriage" and confirms amount. Booking actualCost updated.
...
**Acceptance Criteria:**
- I can click "Issue Credit Note" from booking or invoice
- I can specify:
...
**Acceptance Criteria:**
- For import bookings, I can click "Assign Customs Broker"
...
- Broker appears as stakeholder on booking with access to documents
- I can see broker assignment history
- I can reassign broker if needed

**Example:**
> Import booking arriving LAX. Sarah assigns "ABC Customs Brokers" who specialize in LAX imports. Broker receives email with booking details and ETA (Jan 25), starts preparing customs entry.

---

### Story 41: Submit Documents for Customs
**As a** customs broker (or booking coordinator)
...
**Acceptance Criteria:**
- I can click "Calculate Duties" from import booking
- System requires:
...
**As a** booking coordinator (or customs broker)
...
- Booking status updates to "Customs Cleared"
...
**Example:**
> Customs releases cargo on Jan 27 at 14:30. System receives webhook from ACE, updates booking status to "Customs Cleared", emails customer and trucker. Sarah schedules delivery for Jan 28.
...
- Dashboard shows "VGM Status" for all containers:
  ...
  - ❌ Missed Deadline
- I can filter bookings by VGM status
- System sends alerts:
...
**Example:**
> Dashboard shows: Booking EXP/FCL/00001/2026/ABC has 2 containers - Container 1: ✅ VGM Confirmed, Container 2: ⚠️ Not Submitted (deadline in 18h). Sarah immediately chases customer for Container 2 VGM.

---

## Reporting & Analytics Stories

### Story 23: View My Active Bookings
**As a** booking coordinator
**I want to** see all my active bookings with action items
**So that** I can prioritize my work

**Acceptance Criteria:**
- I can see "My Active Bookings" dashboard showing:
  - **Action Required** (pending user tasks with SLA approaching)
  - **Awaiting Customer** (waiting for customer confirmation)
  - **In Transit** (carrier bookings confirmed, monitoring)
  - **Completed** (delivered, awaiting financial close)
- Each booking shows:
  - Booking number, customer, cargo type
  - Current workflow step with status badge
  - SLA countdown (if applicable)
  - Next action required
- I can click to jump directly to booking detail
...
### Story 24: Booking Performance Analytics
**As a** operations manager
**I want to** view booking performance metrics
**So that** I can identify bottlenecks and improve processes

**Acceptance Criteria:**
- I can access "Booking Analytics" dashboard showing:
  - **Volume**: Total bookings created/completed per month
  - **Conversion Rate**: % of bookings that reach "Financially Closed" vs. cancelled
  - **SLA Compliance**: % of user tasks completed within SLA
  - **Average Cycle Time**: Days from booking creation to financial close
...
|------|----------------|---------------------|
| **Booking Coordinator** | 1-7, 11-16, 21, 23-27, 31-33, 35, 38, 40-41, 46-48 | Create bookings, plan routes, enter cargo, monitor shipments, confirm delivery, upload documents, handle amendments, manage exceptions, submit VGM |
| **Customer (External)** | 9-10 | Review and confirm bookings |
...
| **System (Automated)** | 8, 11, 14-15, 17, 32 | Validation, carrier booking, tracking updates, demurrage calculation, major delay detection |

**Total User Stories**: 50 stories across 14 phases
- **Phase 1-2**: Booking Creation & Route Planning (4 stories)
- **Phase 3**: Cargo Entry (3 stories)
- **Phase 4**: Validation & Confirmation (3 stories)
- **Phase 5**: Carrier Booking & Execution (3 stories)
...
- **Phase 10**: Booking Amendments (4 stories)
...
Here's how a typical booking progresses through all stories:

```
Day 1:  Story 1  → Sarah creates booking (Draft)
...
Day 2:  Story 9  → Customer confirms booking (Booking Confirmed)
        Story 11 → System books all 3 carriers (Request Carrier Bookings)
...
- **Carrier Booking** (Stories 11-13): 5-15 minutes (automated)
- **In Transit** (Stories 14-16): 10-21 days (depends on route)
- **Financial Close** (Stories 17-20): 10-15 minutes per booking

**Total Cycle Time**: ~12-23 days from booking creation to financial close
