...
export class Migration20260116153854 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "booking_service_tag_assignments" drop constraint "booking_service_tag_assignments_tag_id_foreign";`);

    this.addSql(`alter table "booking_service_tag_assignments" drop constraint "booking_service_tag_assignments_service_id_foreign";`);
    ...
    this.addSql(`drop index "fms_quotes_client_idx";`);
    this.addSql(`alter table "fms_quotes" drop column "origin_port_code", drop column "destination_port_code", drop column "client_name";`);
  }
