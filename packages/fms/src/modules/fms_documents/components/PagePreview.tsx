...
export function PagePreview({
  ...
  const resolvedId = entityId || invoiceId || ''
  const baseUrl = imageUrlBase || `/api/fms_documents/invoices/${resolvedId}/pages`
  const imageUrl = `${baseUrl}/${pageNumber}/image`
  ...
  const handleDownload = () => {
    ...
    link.href = imageUrl
    link.download = `page-${resolvedId}-${pageNumber}.png`
