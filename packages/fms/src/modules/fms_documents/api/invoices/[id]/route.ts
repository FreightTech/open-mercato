...
import { updateInvoiceSchema, approveInvoiceSchema, rejectInvoiceSchema } from '../../../data/invoice-validators'
// Import to register commands
import '../../../commands'

const routeMetadata = {
  GET: { requireAuth: true, requireFeatures: ['fms_documents.invoices.view'] },
  PUT: { requireAuth: true, requireFeatures: ['fms_documents.invoices.manage'] },
  DELETE: { requireAuth: true, requireFeatures: ['fms_documents.invoices.delete'] },
  POST: { requireAuth: true, requireFeatures: ['fms_documents.invoices.approve'] },
}
...
export async function DELETE(request: NextRequest, context: RouteContext) {
  ...
  try {
    const { result } = await bus.execute('fms_documents.invoices.delete', {
      input: { id },
      ctx,
    })
