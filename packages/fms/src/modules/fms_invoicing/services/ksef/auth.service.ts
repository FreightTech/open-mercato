...
import { FmsInvoicingKsefCredential, FmsInvoicingKsefSession } from '../../data/entities'
...
interface AuthenticateResult {
  ...
  session: FmsInvoicingKsefSession
}
...
export class KsefAuthService {
  ...
  async authenticate(em: EntityManager, params: AuthenticateParams): Promise<AuthenticateResult> {
    ...
    const session = em.create(FmsInvoicingKsefSession, {
      organizationId,
      tenantId,
