...
@Entity({ tableName: 'fms_invoicing_invoices' })
@Index({ name: 'fms_invoicing_invoices_scope_idx', properties: ['organizationId', 'tenantId'] })
@Index({ name: 'fms_invoicing_invoices_status_idx', properties: ['organizationId', 'tenantId', 'status'] })
@Index({ name: 'fms_invoicing_invoices_ksef_status_idx', properties: ['organizationId', 'tenantId', 'ksefStatus'] })
@Index({ name: 'fms_invoicing_invoices_seller_tax_idx', properties: ['organizationId', 'tenantId', 'sellerTaxId'] })
@Index({ name: 'fms_invoicing_invoices_date_idx', properties: ['organizationId', 'tenantId', 'invoiceDate'] })
@Index({ name: 'fms_invoicing_invoices_source_doc_idx', properties: ['sourceDocumentInvoiceId'] })
@Index({ name: 'fms_invoicing_invoices_source_sales_idx', properties: ['sourceSalesInvoiceId'] })
export class FmsInvoicingInvoice {
  [OptionalProps]?:
    | 'createdAt'
    | 'updatedAt'
    | 'deletedAt'
  ...
  @Index({ name: 'fms_invoicing_invoices_ksef_number_idx' })
  @Unique({ name: 'fms_invoicing_invoices_ksef_number_uniq' })
  ...
  @OneToMany(() => FmsInvoicingLineItem, (li) => li.invoice)
  lineItems = new Collection<FmsInvoicingLineItem>(this)
}
...
@Entity({ tableName: 'fms_invoicing_line_items' })
@Index({ name: 'fms_invoicing_line_items_scope_idx', properties: ['organizationId', 'tenantId'] })
@Index({ name: 'fms_invoicing_line_items_invoice_idx', properties: ['invoice'] })
export class FmsInvoicingLineItem {
  [OptionalProps]?:
    | 'createdAt'
    | 'updatedAt'
    | 'quantity'
  ...
  @ManyToOne(() => FmsInvoicingInvoice, { deleteRule: 'cascade' })
  invoice!: FmsInvoicingInvoice
...
@Entity({ tableName: 'fms_invoicing_ksef_sessions' })
@Index({ name: 'fms_invoicing_ksef_sessions_scope_idx', properties: ['organizationId', 'tenantId'] })
export class FmsInvoicingKsefSession {
  [OptionalProps]?:
    | 'createdAt'
    | 'updatedAt'
    | 'sessionStatus'
...
@Entity({ tableName: 'fms_invoicing_ksef_credentials' })
@Index({ name: 'fms_invoicing_ksef_credentials_scope_idx', properties: ['organizationId', 'tenantId'] })
@Unique({
  name: 'fms_invoicing_ksef_credentials_nip_env_uniq',
  properties: ['organizationId', 'tenantId', 'nip', 'environment'],
})
export class FmsInvoicingKsefCredential {
  [OptionalProps]?:
    | 'createdAt'
    | 'updatedAt'
    | 'environment'
...
@Entity({ tableName: 'fms_invoicing_settings' })
@Index({ name: 'fms_invoicing_settings_scope_idx', properties: ['organizationId', 'tenantId'] })
@Unique({
  name: 'fms_invoicing_settings_tenant_uniq',
  properties: ['organizationId', 'tenantId'],
})
export class FmsInvoicingSettings {
  [OptionalProps]?:
    | 'createdAt'
    | 'updatedAt'
    | 'ksefEnvironment'
