...
const logger = createFmsLogger('fms_invoicing.auto_import_from_documents')

export const metadata = {
  event: 'fms_documents.invoice.updated',
  persistent: true,
  id: 'fms_invoicing.auto_import_from_documents',
}
...
export default async function handle(
  ...
  try {
    ...
    // Import the document invoice into fms_invoicing
