...
export const RECEIVE_SYNC_QUEUE_NAME = 'fms-invoicing-ksef-receive-sync'

export const metadata: WorkerMeta = {
  queue: RECEIVE_SYNC_QUEUE_NAME,
  concurrency: 2,
  id: 'fms-invoicing-ksef-receive-sync',
}
...
const logger = createFmsLogger('fms_invoicing.ksef_receive_sync')
...
async function importReceivedInvoice(
  ...
  await emitFmsInvoicingEvent('fms_invoicing.ksef.received', {
    id: invoice.id,
    tenantId,
    organizationId,
    invoiceNumber: header.invoiceNumber,
