...
export default function FmsInvoicingPage() {
  const table = useDynamicTablePage<FmsInvoiceRow>({
    source: '/api/fms-invoicing/invoices',
    columns,
    tableName: 'Invoices',
    defaultSort: { field: 'createdAt', direction: 'desc' },
    queryKey: 'fms_invoicing',
    tableProps: {
      height: 'fill',
      uiConfig: {
