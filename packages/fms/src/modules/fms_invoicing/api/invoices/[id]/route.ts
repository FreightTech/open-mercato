...
const routeMetadata = {
  GET: { requireAuth: true, requireFeatures: ['fms_invoicing.invoices.view'] },
  PATCH: { requireAuth: true, requireFeatures: ['fms_invoicing.invoices.manage'] },
  DELETE: { requireAuth: true, requireFeatures: ['fms_invoicing.invoices.delete'] },
}
...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  const invoice = await em.findOne(FmsInvoicingInvoice, { id, tenantId, deletedAt: null })
...
export async function PATCH(request: NextRequest, context: RouteContext) {
  ...
  try {
    const { result } = await bus.execute('fms_invoicing.invoices.update', {
      input: {
        id,
        ...parse.data,
...
export async function DELETE(request: NextRequest, context: RouteContext) {
  ...
  try {
    const { result } = await bus.execute('fms_invoicing.invoices.delete', {
      input: { id },
      ctx,
    })
