...
export async function POST(request: NextRequest) {
  ...
  try {
    const invoicingService = container.resolve('fmsInvoicingService') as InvoicingService
...
export const openApi: OpenApiRouteDoc = {
  ...
  methods: {
    POST: {
      ...
      description: 'Create an fms_invoicing invoice from an fms_documents extracted invoice',
    },
  },
}
