...
import type { FmsInvoicingService } from '../../../services/invoicing.service'
...
export async function POST(request: NextRequest) {
  ...
  try {
    const fmsFmsInvoicingService = container.resolve('fmsFmsInvoicingService') as FmsInvoicingService
    const em = container.resolve('em') as import('@mikro-orm/postgresql').EntityManager

    const result = await fmsFmsInvoicingService.importFromDocumentInvoice(em, {
