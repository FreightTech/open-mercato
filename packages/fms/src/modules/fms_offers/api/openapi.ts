...
const buildFmsOffersCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'FMS Offers',
...
export function createFmsOffersCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildFmsOffersCrudOpenApi(options)
}
