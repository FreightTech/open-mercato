...
export async function POST(req: Request, { params }: Params) {
  ...
  try {
    const { result } = await commandBus.execute('fms_offers.offers.convert_to_project', {
      input: {
        offerId,
...
export const metadata = {
  POST: { requireAuth: true, requireFeatures: ['fms_offers.offers.manage', 'fms_projects.projects.manage'] },
}
