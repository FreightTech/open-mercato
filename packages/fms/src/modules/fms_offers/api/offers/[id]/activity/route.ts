/**
 * Offer Activity Aggregation API
 * Aggregates notes, legacy annotations, documents, and status events into a timeline.
 */
...
export const openApi = {
  GET: {
    summary: 'Get offer activity timeline',
    description: 'Aggregates notes, documents, and status events into a chronological activity feed.',
    tags: ['fms_offers'],
    parameters: [
...
export async function GET(req: Request, ctx: { params?: { id?: string } }) {
  ...
  const offerId = paramsResult.data.id
  ...
  // --- Status events (derived from offer record) ---
