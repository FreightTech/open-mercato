...
export class Migration20260116153854 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table if exists "fms_documents" drop constraint if exists "fms_documents_attachment_id_foreign";`);

    this.addSql(`alter table if exists "booking_resource_tag_assignments" drop constraint if exists "booking_resource_tag_assignments_tag_id_foreign";`);

    this.addSql(`alter table if exists "booking_service_tag_assignments" drop constraint if exists "booking_service_tag_assignments_tag_id_foreign";`);

    this.addSql(`alter table if exists "booking_service_tag_assignments" drop constraint if exists "booking_service_tag_assignments_service_id_foreign";`);

    this.addSql(`alter table if exists "fms_shipments" drop constraint if exists "shipments_client_id_foreign";`);

    this.addSql(`alter table if exists "fms_shipments" drop constraint if exists "shipments_consignee_id_foreign";`);

    this.addSql(`alter table if exists "fms_shipments" drop constraint if exists "shipments_contact_person_id_foreign";`);

    this.addSql(`alter table if exists "fms_shipments" drop constraint if exists "shipments_shipper_id_foreign";`);
    ...
    this.addSql(`alter table if exists "fms_products" drop constraint if exists "fms_products_charge_code_id_foreign";`);

    this.addSql(`alter table if exists "fms_product_prices" drop constraint if exists "fms_product_prices_variant_id_foreign";`);

    this.addSql(`alter table if exists "fms_product_variants" drop constraint if exists "fms_product_variants_product_id_foreign";`);

    this.addSql(`alter table if exists "fms_shipment_containers" drop constraint if exists "shipment_containers_shipment_id_foreign";`);
    ...
    this.addSql(`alter table if exists "fms_shipment_tasks" drop constraint if exists "shipment_tasks_assigned_to_id_foreign";`);

    this.addSql(`alter table if exists "fms_shipments" drop constraint if exists "shipments_assigned_to_id_foreign";`);

    this.addSql(`alter table if exists "fms_shipments" drop constraint if exists "shipments_created_by_id_foreign";`);

    this.addSql(`create table "fms_bookings" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "booking_number" text not null, "client_id" uuid null, "quote_id" uuid null, "offer_id" uuid null, "shipment_id" uuid null, "workflow_instance_id" uuid null, "current_step" text null, "workflow_context" jsonb null, "shipment_type" text not null, "direction" text not null, "cargo_type" text not null, "incoterm" text null, "origin_location_id" uuid null, "destination_location_id" uuid null, "origin_address" text null, "destination_address" text null, "booking_date" timestamptz not null, "requested_pickup_date" timestamptz null, "requested_delivery_date" timestamptz null, "client_reference" text null, "internal_reference" text null, "commodity_description" text null, "hs_code" text null, "container_count" int null, "total_gross_weight" numeric(18,4) null, "total_volume" numeric(18,4) null, "weight_unit" text null, "volume_unit" text null, "currency_code" text not null default 'USD', "estimated_cost" numeric(18,4) null, "requires_insurance" boolean not null default false, "requires_customs_brokerage" boolean not null default false, "is_hazardous" boolean not null default false, "hazmat_details" text null, "special_instructions" text null, "internal_notes" text null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "fms_bookings_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_booking_legs" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "booking_id" uuid not null, "leg_sequence" int not null, "transport_mode" text not null, "origin_location_id" uuid null, "destination_location_id" uuid null, "origin_address" text null, "destination_address" text null, "carrier_id" uuid null, "carrier_name" text null, "vessel_name" text null, "voyage_number" text null, "flight_number" text null, "estimated_departure" timestamptz null, "estimated_arrival" timestamptz null, "actual_departure" timestamptz null, "actual_arrival" timestamptz null, "estimated_cost" numeric(18,4) null, "actual_cost" numeric(18,4) null, "notes" text null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "fms_booking_legs_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_booking_containers" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "booking_id" uuid not null, "container_type" text not null, "container_number" text null, "seal_number" text null, "ownership_type" text not null default 'coc', "length" numeric(18,4) null, "width" numeric(18,4) null, "height" numeric(18,4) null, "dimension_unit" text null, "tare_weight" numeric(18,4) null, "gross_weight" numeric(18,4) null, "net_weight" numeric(18,4) null, "weight_unit" text null, "commodity_description" text null, "package_count" int null, "is_reefer" boolean not null default false, "temperature_min" numeric(18,4) null, "temperature_max" numeric(18,4) null, "temperature_unit" text null, "is_hazardous" boolean not null default false, "hazmat_class" text null, "un_number" text null, "pickup_date" timestamptz null, "delivery_date" timestamptz null, "status" text not null default 'not_ready', "notes" text null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "fms_booking_containers_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_booking_cargo" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "booking_id" uuid not null, "cargo_sequence" int null, "commodity_description" text not null, "hs_code" text null, "package_type" text not null, "package_count" int not null, "marks_and_numbers" text null, "length" numeric(18,4) null, "width" numeric(18,4) null, "height" numeric(18,4) null, "dimension_unit" text null, "gross_weight" numeric(18,4) not null, "net_weight" numeric(18,4) null, "weight_unit" text not null, "volume" numeric(18,4) null, "volume_unit" text null, "is_hazardous" boolean not null default false, "hazmat_class" text null, "un_number" text null, "is_stackable" boolean not null default true, "requires_refrigeration" boolean not null default false, "temperature_min" numeric(18,4) null, "temperature_max" numeric(18,4) null, "temperature_unit" text null, "declared_value" numeric(18,4) null, "declared_value_currency" text null, "status" text not null default 'not_ready', "notes" text null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "fms_booking_cargo_pkey" primary key ("id"));`);
    ...
    this.addSql(`alter table if exists "fms_quotes" drop column if exists "origin_port_code", drop column if exists "destination_port_code", drop column if exists "client_name";`);
  }

  override async down(): Promise<void> {
    this.addSql(`alter table "fms_booking_legs" drop constraint "fms_booking_legs_booking_id_foreign";`);

    this.addSql(`alter table "fms_booking_containers" drop constraint "fms_booking_containers_booking_id_foreign";`);

    this.addSql(`alter table "fms_booking_cargo" drop constraint "fms_booking_cargo_booking_id_foreign";`);
    ...
    this.addSql(`create table "booking_teams" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "name" text not null, "description" text null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "booking_teams_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_charge_codes" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "code" text not null, "description" text null, "charge_unit" text not null, "field_schema" jsonb null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, constraint "fms_charge_codes_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_documents" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "category" text not null default 'other', "description" text null, "document_number" text null, "issue_date" date null, "expiry_date" date null, "attachment_id" uuid not null, "related_entity_id" uuid null, "related_entity_type" text null, "extracted_data" jsonb null, "processed_at" timestamptz(6) null, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, constraint "fms_documents_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_product_variants" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "product_id" uuid not null, "provider_id" uuid not null, "name" text null, "is_default" bool not null default false, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, "variant_type" text check ("variant_type" in ('container', 'simple')) not null, "container_size" text null, "container_type" text null, "weight_limit" numeric(10,0) null, "weight_unit" text null, constraint "fms_product_variants_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_products" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "charge_code_id" uuid not null, "service_provider_id" uuid not null, "description" text null, "internal_notes" text null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, "product_type" text check ("product_type" in ('GBAF_PIECE', 'GBAF', 'GBOL', 'CUSTOM', 'GCUS', 'GFRT', 'GTHC')) not null, "loop" text null, "source_id" uuid null, "destination_id" uuid null, "transit_time" int4 null, "location_id" uuid null, constraint "fms_products_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "mikro_orm_migrations_booking" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);
    ...
    this.addSql(`create table "vector_search" ("id" uuid not null default gen_random_uuid(), "driver_id" text not null, "entity_id" text not null, "record_id" text not null, "tenant_id" uuid not null, "organization_id" uuid null, "checksum" text not null, "embedding" vector(768) not null, "url" text null, "presenter" jsonb null, "links" jsonb null, "payload" jsonb null, "result_title" text null, "result_subtitle" text null, "result_icon" text null, "result_badge" text null, "result_snapshot" text null, "primary_link_href" text null, "primary_link_label" text null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), constraint "vector_search_pkey" primary key ("id"));`);
    ...
    this.addSql(`alter table "booking_resource_tag_assignments" add constraint "booking_resource_tag_assignments_tag_id_foreign" foreign key ("tag_id") references "booking_resource_tags" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "booking_service_tag_assignments" add constraint "booking_service_tag_assignments_service_id_foreign" foreign key ("service_id") references "booking_services" ("id") on update cascade on delete no action;`);
    this.addSql(`alter table "booking_service_tag_assignments" add constraint "booking_service_tag_assignments_tag_id_foreign" foreign key ("tag_id") references "booking_resource_tags" ("id") on update cascade on delete no action;`);
    ...
    this.addSql(`alter table "contractor_credit_limits" drop constraint "contractor_credit_limits_contractor_unique";`);

    this.addSql(`alter table "contractor_payment_terms" drop constraint "contractor_payment_terms_contractor_unique";`);

    this.addSql(`alter table "fms_quotes" add column "origin_port_code" text null, add column "destination_port_code" text null, add column "client_name" text null;`);
