...
import { createAirportSchema } from '../../data/validators'
...
export const metadata = {
  ...
  POST: { requireAuth: true, requireFeatures: ['fms_locations.airports.manage'] },
}
...
export async function GET(request: NextRequest) {
  ...
  const sortField = sortFieldMap[parse.data.sortField || 'code'] || 'code'
