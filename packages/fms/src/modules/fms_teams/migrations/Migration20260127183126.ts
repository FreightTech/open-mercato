...
export class Migration20260127183126 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table "contractor_addresses" drop constraint if exists "contractor_addresses_contractor_id_foreign";`);

    this.addSql(`alter table "contractor_contacts" drop constraint if exists "contractor_contacts_contractor_id_foreign";`);

    this.addSql(`alter table "contractor_credit_limits" drop constraint if exists "contractor_credit_limits_contractor_id_foreign";`);

    this.addSql(`alter table "contractor_payment_terms" drop constraint if exists "contractor_payment_terms_contractor_id_foreign";`);

    this.addSql(`alter table "fms_product_variants" drop constraint if exists "fms_product_variants_provider_id_foreign";`);

    this.addSql(`alter table "fms_project_legs" drop constraint if exists "fms_project_legs_carrier_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint if exists "fms_projects_client_id_foreign";`);
    ...
    this.addSql(`alter table "fms_invoice_pages" drop constraint if exists "fms_invoice_pages_invoice_id_foreign";`);
    ...
    this.addSql(`alter table "fms_project_legs" drop constraint if exists "fms_project_legs_destination_location_id_foreign";`);

    this.addSql(`alter table "fms_project_legs" drop constraint if exists "fms_project_legs_origin_location_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint if exists "fms_projects_destination_location_id_foreign";`);

    this.addSql(`alter table "fms_projects" drop constraint if exists "fms_projects_origin_location_id_foreign";`);
