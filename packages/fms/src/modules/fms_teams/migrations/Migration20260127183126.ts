...
export class Migration20260127183126 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "fms_quotes" drop constraint "fms_quotes_client_id_foreign";`);

    this.addSql(`alter table "fms_products" drop constraint "fms_products_carrier_id_foreign";`);

    this.addSql(`alter table "fms_invoice_line_items" drop constraint "fms_invoice_line_items_charge_code_id_foreign";`);
    ...
    this.addSql(`alter table "fms_products" drop constraint "fms_products_destination_id_foreign";`);

    this.addSql(`alter table "fms_products" drop constraint "fms_products_location_id_foreign";`);

    this.addSql(`alter table "fms_products" drop constraint "fms_products_source_id_foreign";`);
    ...
    this.addSql(`alter table "fms_quote_destination_ports" drop constraint "fms_quote_destination_ports_location_id_foreign";`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create table "fms_price_types" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "code" text not null, "name" text not null, "description" text null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, constraint "fms_price_types_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_quotes" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "quote_number" text null, "status" text not null default 'draft', "direction" text null, "incoterm" text null, "cargo_type" text null, "origin_port_code" text null, "destination_port_code" text null, "valid_until" timestamptz(6) null, "currency_code" text not null default 'USD', "notes" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "client_name" text null, "container_count" int4 null, "client_id" uuid null, "assigned_to_id" uuid null, "modes" jsonb null, constraint "fms_quotes_pkey" primary key ("id"));`);
    this.addSql(`create index "fms_quotes_assigned_to_idx" on "fms_quotes" ("assigned_to_id");`);
