import type { InvoicingInvoice, InvoicingLineItem } from '../../data/entities'
import {
  FA3_NAMESPACE,
...
function buildSeller(invoice: InvoicingInvoice): string {
...
function buildBuyer(invoice: InvoicingInvoice): string {
