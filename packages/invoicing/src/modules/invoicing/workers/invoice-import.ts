...
export const IMPORT_QUEUE_NAME = 'invoicing-invoice-import'

export const metadata: WorkerMeta = {
  queue: IMPORT_QUEUE_NAME,
  concurrency: 3,
  id: 'invoicing-invoice-import',
}
...
const logger = createInvoicingLogger('invoicing.invoice_import')
...
export default async function handle(
  ...
  try {
    ...
    await emitInvoicingEvent('invoicing.import.completed', eventPayload)
  } catch (err: unknown) {
    ...
    await emitInvoicingEvent('invoicing.import.failed', failedPayload)
