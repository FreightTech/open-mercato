...
/**
 * KSeF API v2 HTTP client.
 *
 * Uses Bearer token auth (Authorization: Bearer <accessToken>).
 * Authentication is handled by KsefAuthService — this client only
 * makes authenticated API calls after a token is set.
 */
