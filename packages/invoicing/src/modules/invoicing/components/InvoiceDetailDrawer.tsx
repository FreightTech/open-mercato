                ...
                <div style={{
                  ...
                  {invoice.ksefStatus && invoice.ksefStatus !== 'none' && (
                    <div style={{ marginLeft: 'auto' }}>
                      <span style={{ opacity: 0.6 }}>KSeF: {invoice.ksefStatus}</span>
                      {invoice.ksefNumber && <span style={{ marginLeft: '6px', fontFamily: 'monospace', fontSize: '11px' }}>{invoice.ksefNumber}</span>}
                    </div>
                  )}
                </div>
