...
describe('findLatestVesselInfo', () => {
  ...
  it('should handle transshipment (multiple vessels)', () => {
    const events = [
      { vesselName: 'SOFIA EXPRESS', vesselImo: '9450404', voyageNumber: '101N' },
      { vesselName: 'W KAMPALA', vesselImo: '9215311', voyageNumber: '102N' },
      { vesselName: 'SEASPAN MONTEVIDEO', vesselImo: '9385984', voyageNumber: '603N' },
      { vesselName: null, vesselImo: null, voyageNumber: null }, // GTOT
      { vesselName: null, vesselImo: null, voyageNumber: null }, // GTIN
    ]
    // Should return the last vessel (SEASPAN MONTEVIDEO)
    expect(findLatestVesselInfo(events)).toEqual({
      vesselName: 'SEASPAN MONTEVIDEO',
      vesselImo: '9385984',
      voyageNumber: '603N',
    })
  })
