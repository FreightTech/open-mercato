...
export class Migration20260207200002 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table "fms_documents" drop constraint "fms_documents_attachment_id_foreign";`);
    ...
    this.addSql(`alter table "fms_locations" drop constraint "fms_locations_contractor_id_fkey";`);

    this.addSql(`alter table "fms_shipments" drop constraint "shipments_client_id_foreign";`);

    this.addSql(`alter table "fms_shipments" drop constraint "shipments_consignee_id_foreign";`);

    this.addSql(`alter table "fms_shipments" drop constraint "shipments_contact_person_id_foreign";`);

    this.addSql(`alter table "fms_shipments" drop constraint "shipments_shipper_id_foreign";`);
    ...
    this.addSql(`alter table "fms_offers" drop constraint "fms_offers_document_id_foreign";`);
    ...
    this.addSql(`alter table "fms_project_lines" drop constraint "fms_project_lines_project_fkey";`);
    ...
    this.addSql(`alter table "fms_quote_destination_ports" drop constraint "fms_quote_destination_ports_quote_id_foreign";`);

    this.addSql(`alter table "fms_quote_lines" drop constraint "fms_quote_lines_quote_id_foreign";`);

    this.addSql(`alter table "fms_quote_origin_ports" drop constraint "fms_quote_origin_ports_quote_id_foreign";`);

    this.addSql(`alter table "fms_shipment_containers" drop constraint "shipment_containers_shipment_id_foreign";`);
    ...
    this.addSql(`alter table "fms_shipment_tasks" drop constraint "shipment_tasks_assigned_to_id_foreign";`);

    this.addSql(`alter table "fms_shipments" drop constraint "shipments_assigned_to_id_foreign";`);

    this.addSql(`alter table "fms_shipments" drop constraint "shipments_created_by_id_foreign";`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create table "contractors" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "name" text not null, "short_name" text null, "parent_id" uuid null, "tax_id" text null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "role_type_ids" jsonb null, "official_name" text null, "krs" text null, "registration_date" text null, "pkd_main_code" text null, "pkd_main_description" text null, "regon" text null, constraint "contractors_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_charge_codes" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "code" text not null, "description" text null, "charge_unit" text not null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, "name" text null, "keywords" text null, "usage" text null, constraint "fms_charge_codes_pkey" primary key ("id"));`);
    ...
    this.addSql(`alter table "fms_invoice_pages" add constraint "fms_invoice_pages_invoice_page_unique" unique ("invoice_id", "page_number");`);
    ...
    this.addSql(`create table "fms_locations" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "code" text not null, "name" text not null, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, "product_type" text not null, "locode" text null, "port_id" uuid null, "lat" float8 null, "lng" float8 null, "city" text null, "country" text null, "contractor_id" uuid null, "address_line1" text null, "address_line2" text null, "state" text null, "postal_code" text null, "is_primary" bool not null default false, "is_active" bool not null default true, "google_place_id" text null, constraint "fms_locations_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_offer_lines" ("id" uuid not null default gen_random_uuid(), "offer_id" uuid not null, "organization_id" uuid not null, "tenant_id" uuid not null, "line_number" int4 not null default 0, "quantity" numeric(18,4) not null default '1', "currency_code" text not null, "unit_price" numeric(18,4) not null default '0', "amount" numeric(18,4) not null default '0', "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "product_name" text null, "charge_code" text null, "container_size" text null, "product_id" uuid null, "variant_id" uuid null, "provider_id" uuid null, "source_quote_line_id" uuid null, "reference" text null, "validity_start" date null, "validity_end" date null, "unit_cost" numeric(18,4) not null default '0', "carrier_id" uuid null, constraint "fms_offer_lines_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_offers" ("id" uuid not null default gen_random_uuid(), "quote_id" uuid not null, "organization_id" uuid not null, "tenant_id" uuid not null, "offer_number" text not null, "status" text not null default 'draft', "valid_until" timestamptz(6) null, "notes" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "version" int4 not null default 1, "payment_terms" text null, "special_terms" text null, "customer_notes" text null, "superseded_by_id" uuid null, "assigned_to_id" uuid null, "document_id" uuid null, "sent_at" timestamptz(6) null, "sent_to_email" text null, "exchange_rates" jsonb null, "operational_guardian_id" uuid null, "business_guardian_id" uuid null, constraint "fms_offers_pkey" primary key ("id"));`);
    this.addSql(`create index "fms_offers_assigned_to_idx" on "fms_offers" ("assigned_to_id");`);
    this.addSql(`create index "fms_offers_document_idx" on "fms_offers" ("document_id");`);
    ...
    this.addSql(`create table "fms_product_variants" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "product_id" uuid not null, "provider_id" uuid null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "created_by" uuid null, "updated_at" timestamptz(6) not null, "updated_by" uuid null, "deleted_at" timestamptz(6) null, "container_size" text null, "validity_start" date null, "validity_end" date null, "price" numeric(18,2) null, "currency_code" text not null default 'USD', "reference" text null, "internal_notes" text null, constraint "fms_product_variants_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_quote_lines" ("id" uuid not null default gen_random_uuid(), "quote_id" uuid not null, "organization_id" uuid not null, "tenant_id" uuid not null, "line_number" int4 not null default 0, "product_id" uuid null, "variant_id" uuid null, "product_name" text not null, "charge_code" text null, "product_type" text null, "container_size" text null, "reference" text null, "currency_code" text not null default 'USD', "unit_cost" numeric(18,4) not null default '0', "margin_percent" numeric(8,4) not null default '0', "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "provider_id" uuid null, "validity_start" date null, "validity_end" date null, "origin_location_id" uuid null, "destination_location_id" uuid null, "unit_sales" numeric(18,4) not null default '0', constraint "fms_quote_lines_pkey" primary key ("id"));`);
    this.addSql(`create index "fms_quote_lines_org_tenant_idx" on "fms_quote_lines" ("organization_id", "tenant_id");`);
    this.addSql(`create index "fms_quote_lines_provider_idx" on "fms_quote_lines" ("provider_id");`);
    ...
    this.addSql(`create table "fms_quotes" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "quote_number" text null, "status" text not null default 'draft', "direction" text null, "cargo_type" text null, "origin_port_code" text null, "destination_port_code" text null, "currency_code" text not null default 'USD', "notes" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "client_name" text null, "container_count" int4 null, "client_id" uuid null, "modes" jsonb null, "operational_guardian_id" uuid null, "business_guardian_id" uuid null, constraint "fms_quotes_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "fms_tracking_freighttech_settings" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "api_key" text not null default '', "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "api_base_url" text not null default '', constraint "fms_tracking_settings_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "mikro_orm_migrations_shipments" ("id" serial primary key, "name" varchar(255) null, "executed_at" timestamptz(6) null default CURRENT_TIMESTAMP);`);
    ...
    this.addSql(`alter table "fms_documents" add constraint "fms_documents_attachment_id_foreign" foreign key ("attachment_id") references "attachments" ("id") on update cascade on delete restrict;`);

    this.addSql(`alter table "fms_locations" add constraint "fms_locations_contractor_id_fkey" foreign key ("contractor_id") references "contractors" ("id") on update no action on delete set null;`);

    this.addSql(`alter table "fms_offer_lines" add constraint "fms_offer_lines_offer_id_foreign" foreign key ("offer_id") references "fms_offers" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "fms_offers" add constraint "fms_offers_document_id_foreign" foreign key ("document_id") references "fms_documents" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "fms_offers" add constraint "fms_offers_quote_id_foreign" foreign key ("quote_id") references "fms_quotes" ("id") on update cascade on delete no action;`);
    ...
    this.addSql(`alter table "fms_project_lines" add constraint "fms_project_lines_project_fkey" foreign key ("project_id") references "fms_projects" ("id") on update no action on delete cascade;`);
    ...
    this.addSql(`alter table "fms_quote_lines" add constraint "fms_quote_lines_quote_id_foreign" foreign key ("quote_id") references "fms_quotes" ("id") on update cascade on delete no action;`);
    ...
    this.addSql(`alter table "fms_shipment_containers" add constraint "shipment_containers_shipment_id_foreign" foreign key ("shipment_id") references "fms_shipments" ("id") on update cascade on delete no action;`);

    this.addSql(`alter table "fms_shipment_tasks" add constraint "shipment_tasks_assigned_to_id_foreign" foreign key ("assigned_to_id") references "users" ("id") on update cascade on delete set null;`);

    this.addSql(`alter table "fms_shipments" add constraint "shipments_assigned_to_id_foreign" foreign key ("assigned_to_id") references "users" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "fms_shipments" add constraint "shipments_client_id_foreign" foreign key ("client_id") references "customer_entities" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "fms_shipments" add constraint "shipments_consignee_id_foreign" foreign key ("consignee_id") references "customer_entities" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "fms_shipments" add constraint "shipments_contact_person_id_foreign" foreign key ("contact_person_id") references "customer_entities" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "fms_shipments" add constraint "shipments_created_by_id_foreign" foreign key ("created_by_id") references "users" ("id") on update cascade on delete set null;`);
    this.addSql(`alter table "fms_shipments" add constraint "shipments_shipper_id_foreign" foreign key ("shipper_id") references "customer_entities" ("id") on update cascade on delete set null;`);
