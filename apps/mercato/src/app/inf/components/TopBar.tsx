...
export function TopBar() {
  ...
  return (
    <div className="bg-[#14363C] py-2.5">
      <div className="mx-auto max-w-[1440px] px-6 flex items-center justify-between">
        {/* Left - Contact info */}
        <div className="flex items-center gap-6 font-sans text-sm text-white">
          <a
            href="tel:+48786660935"
            className="flex items-center gap-2 hover:text-[#EB5C2E] transition-colors"
          >
          ...
          <a
            ...
            className="hidden md:flex items-center gap-2 hover:text-[#EB5C2E] transition-colors"
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1 border-r border-white/20 pr-4">
            {languages.map((lang) => (
              <button
                ...
                className={`flex items-center gap-1 rounded px-2 py-1 font-sans text-xs transition-colors ${
                  locale === lang.code
          ...
          <a
            ...
            className="text-white hover:text-[#EB5C2E] transition-colors"
          >
