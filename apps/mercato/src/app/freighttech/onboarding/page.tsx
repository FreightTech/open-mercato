...
export default function FreightTechOnboardingPage() {
  const t = useT()
            ...
            <form className="grid gap-4" onSubmit={onSubmit} noValidate>
              <div className="grid gap-1">
                ...
                <Input
                  ...
                  className={`border-gray-300 bg-white ${fieldErrors.email ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                />
                {fieldErrors.email && (
              ...
              <div className="grid gap-1 sm:grid-cols-2 sm:gap-4">
                <div className="grid gap-1">
                  ...
                  <Input
                    ...
                    className={`border-gray-300 bg-white ${fieldErrors.firstName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                  />
                ...
                <div className="grid gap-1">
                  ...
                  <Input
                    ...
                    className={`border-gray-300 bg-white ${fieldErrors.lastName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                  />
              ...
              <div className="grid gap-1">
                ...
                <Input
                  ...
                  className={`border-gray-300 bg-white ${fieldErrors.organizationName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                />
              ...
              <div className="grid gap-1">
                ...
                <Input
                  ...
                  className={`border-gray-300 bg-white ${fieldErrors.password ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                />
              ...
              <div className="grid gap-1">
                ...
                <Input
                  ...
                  disabled={disabled}
                  autoComplete="new-password"
                  className={`border-gray-300 bg-white ${fieldErrors.confirmPassword ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                />
              ...
              <label className="flex items-start gap-3 text-sm text-gray-500">
                ...
                <span>
                  ...
                  <a className="underline hover:text-gray-700" href="/terms" target="_blank" rel="noreferrer">
